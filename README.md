...
The latest databases generated by the previous scripts are also available at: [wcdo.wmflabs.org/databases](http://wcdo.wmflabs.org/databases/). The latest CCC dataset as a database is named as ccc_old.db (Sqlite3 file).
